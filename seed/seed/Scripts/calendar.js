...
{this.dateInput.value="Invalid Date";this.dateInput.style.background="#fff url(http://images.wctravel.com/images-general/warningBG.gif) 100% 50% no-repeat";this.cal.render();return false;}
...
if(isNaN(parseInt(inputDateArray[0]))||isNaN(parseInt(inputDateArray[1]))||isNaN(parseInt(inputDateArray[2])))
{obj.dateInput.value="Invalid Date";obj.dateInput.style.background="#fff url(http://images.wctravel.com/images-general/warningBG.gif) 100% 50% no-repeat";return false;}
else
...
{if(isNaN(parseInt(inputDateArray[0]))||isNaN(parseInt(inputDateArray[1]))||isNaN(parseInt(inputDateArray[2])))
{this.dateInput.value="Invalid Date";this.dateInput.style.background="#fff url(http://images.wctravel.com/images-general/warningBG.gif) 100% 50% no-repeat";return false;}
else
...
{this.dateInput.value="Enter Date";this.dateInput.style.background="#fff url(http://images.wctravel.com/images-general/warningBG.gif) 100% 50% no-repeat";return false;}}
return false;}
